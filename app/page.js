  ...
  return (
    <>
      <header className="cd-header">
        ...
        <div className="cd-user-pill is-hidden" id="cd-user-pill">
          <span className="cd-user-name" id="cd-user-name"></span>
          <button className="cd-logout-btn" onClick={() => cdLogout()} title="Sign out">↩</button>
        </div>
      </header>
      ...
      {/* Google login overlay — shown until auth completes */}
      <div className="cd-login-overlay" id="cd-login-overlay">
